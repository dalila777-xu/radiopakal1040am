...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* ========================================
       FACEBOOK FEED - ESTILOS MEJORADOS
    ======================================== */
...
<body>
  ...
  <div class="container">
    ...
    <section id="facebook-feed">
      <h2><i class="fab fa-facebook"></i> Últimas Publicaciones</h2>
      <p style="margin-bottom: 1rem; color: #666;">
        <i class="fas fa-sync-alt"></i> Contenido actualizado automáticamente desde nuestra página de Facebook. 
        Aquí encontrarás nuestras últimas publicaciones, fotos, videos y en vivos.
      </p>
      <div id="fb-root"></div>
  ...
  <!-- Facebook SDK - Carga el plugin de la página -->
