...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* ========================================
       SECCIONES (MÓDULOS CON EFECTO HOJA)
       ======================================== */
    section {
      background: white;
      border-radius: 8px;
      ...
      /* EFECTO HOJA - Líneas decorativas */
      position: relative;
      box-shadow: 
    ...
    /* Línea decorativa superior (como una hoja rayada) */
    section::before {
      content: '';
      position: absolute;
      top: 0;
      ...
      right: 0;
      height: 4px;
      background: linear-gradient(90deg, #8B2C2D, #D4AF37, #2C5F2D);
    ...
    section::after {
      ...
      left: 0;
      width: 4px;
      background: linear-gradient(180deg, #D4AF37, #8B2C2D, #2C5F2D);
      border-radius: 0 4px 4px 0;
      opacity: 0.5;
    }
    
    /* Línea sutil en el borde derecho */
    .section-content {
      position: relative;
    }
    ...
    /* ========================================
       TABLA PROGRAMACIÓN (con estilo hoja)
    ======================================== */
    .table-responsive {
      overflow-x: auto;
    }
    ...
    td {
      padding: 12px 16px;
      border-bottom: 1px dashed #d4d4d4;  /* Línea discontinua como hoja rayada */
      background: white;
    }

    tr:hover td {
      background: #faf8f5;  /* Color suave al pasar */
    }
    ...
    @media (max-width: 768px) {
      ...
      /* Ajustar línea lateral en móvil */
      section::after {
        top: 1rem;
        bottom: 1rem;
      }
    ...
    @media (max-width: 480px) {
      ...
      /* Ocultar línea lateral en móvil muy pequeño para no saturar */
      section::after {
        width: 2px;
      }
    }
