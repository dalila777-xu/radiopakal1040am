...
<body>
  ...
  <div class="container">
    ...
    <section id="app">
      ...
      <div class="grid-buttons">
        <a href="app/RadioPakal.apk" download class="btn-card app-btn">
          <i class="fas fa-android"></i> Descargar Android
        </a>
        <a href="https://apps.apple.com/us/search?term=radio%20pakal" target="_blank" class="btn-card app-btn">
          <i class="fab fa-apple"></i> Buscar en App Store
        </a>
      </div>
      <p style="margin-top: 1rem; font-size: 0.8rem; color: #666;">
        ...
        En Android descarga el APK directamente. En iOS abre la búsqueda del App Store.
      </p>
    </section>
