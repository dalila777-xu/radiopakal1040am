...
<head>
  ...
  <style>
    ...
    * {
    ...
    header p {
      color: #8B2c2D; /* texto debajo del nombre en rojo */
      font-size: 1.10rem;
    }
...
<body>
  ...
  <header>
    ...
    <p>la vos de palenque que conecta con   las  comunidades</p>
  </header>
  ...
  <div class="container">
    ...
    <section id="quienes">
      ...
      <!-- Carousel: reemplaza la imagen estática -->
      <div class="about-carousel">
        <div class="slides">
          <img src="radio.png" alt="Radio Pakal 1040 image" onerror="this.style.display='none'">
          <img src="radio2.png" alt="Radio Pakal 1040 image 2" onerror="this.style.display='none'">
          <img src="radio3.png" alt="Radio Pakal 1040 image 3" onerror="this.style.display='none'">
        </div>
      ...
      <style>
        .about-carousel { position: relative; width: 100%; max-width: 420px; margin-top: 1rem; }
        .about-carousel .slides { display: flex; overflow: hidden; }
        .about-carousel .slides img { width: 100%; flex-shrink: 0; object-fit: cover; border-radius: 8px; }
        .about-carousel button { position: absolute; top: 50%; transform: translateY(-50%); background: rgba(0,0,0,0.4); color: #fff; border: none; padding: 0.4rem 0.6rem; cursor: pointer; border-radius: 4px; }
        .about-carousel .carousel-prev { left: 8px; }
        .about-carousel .carousel-next { right: 8px; }
      </style>
      ...
      <script>
        (function(){
          ...
          let auto = setInterval(()=>{ index = (index+1)%imgs.length; update(); }, 4000);
          [prev,next,carousel].forEach(el=> el.addEventListener && el.addEventListener('mouseover', ()=> clearInterval(auto)));
          [prev,next,carousel].forEach(el=> el.addEventListener && el.addEventListener('mouseout', ()=> auto = setInterval(()=>{ index = (index+1)%imgs.length; update(); }, 4000)));
        })();
      </script>
    </section>
