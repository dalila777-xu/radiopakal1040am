...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* ========================================
       SECCIONES (MÓDULOS CON LÍNEAS SUTILES)
    ======================================== */
    section {
      background: white;
      border-radius: 16px;
    ...
    /* Línea superior MUY DELGADA - casi invisible pero que distingue */
    section::before {
      content: '';
      position: absolute;
      top: 0;
    ...
    /* Línea lateral izquierda MUY SUTIL */
    section::after {
      content: '';
      position: absolute;
      top: 1.5rem;
      ...
      left: 0;
      width: 2px;
      background: linear-gradient(180deg, #e8e8e8, #d4d4d4, #e8e8e8);
