...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .carousel-dot.active { background: #4494da; transform: scale(1.2); }
...
<body>
  ...
  <div class="container">
          ...
          <div class="carousel">
            <div class="carousel-track-container">
              <ul class="carousel-track">
                <li class="carousel-slide"><img src="7.png" alt="Equipo de Radio Pakal 1" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal+1'"></li>
                <li class="carousel-slide"><img src="B.png" alt="Transmisión en vivo" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal+2'"></li>
                <li class="carousel-slide"><img src="zzz7.png" alt="Comunidades conectadas" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal+3'"></li>
                ...
                <li class="carousel-slide"><img src="D.png" alt="Radio y cultura" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal+5'"></li>
              </ul>
            </div>
    ...
    <section id="noticias" style="margin-top: 2rem;">
      ...
      <div style="display:flex; flex-wrap:wrap; gap:1rem; margin-top:0.75rem;">
        ...
        <article class="tarjeta-noticia" style="flex:1 1 300px; border:1px solid #e5e7eb; border-radius:8px; padding:12px; background:#fff;">
          <h3 style="margin:0 0 6px 0; font-size:1rem;">Título de la noticia 1</h3>
          <p style="margin:0 0 8px 0; color:#6b7280; font-size:0.9rem;">Resumen breve de la publicación. Pulse para leer más.</p>
          <a href="#" style="color:#1f2937; font-weight:600; text-decoration:none;">Leer más →</a>
        </article>

        <article class="tarjeta-noticia" style="flex:1 1 300px; border:1px solid #e5e7eb; border-radius:8px; padding:12px; background:#fff;">
          <h3 style="margin:0 0 6px 0; font-size:1rem;">Título de la noticia 2</h3>
          <p style="margin:0 0 8px 0; color:#6b7280; font-size:0.9rem;">Resumen breve de la publicación. Pulse para leer más.</p>
          <a href="#" style="color:#1f2937; font-weight:600; text-decoration:none;">Leer más →</a>
        </article>

        <article class="tarjeta-noticia" style="flex:1 1 300px; border:1px solid #e5e7eb; border-radius:8px; padding:12px; background:#fff;">
          <h3 style="margin:0 0 6px 0; font-size:1rem;">Título de la noticia 3</h3>
          <p style="margin:0 0 8px 0; color:#6b7280; font-size:0.9rem;">Resumen breve de la publicación. Pulse para leer más.</p>
          <a href="#" style="color:#1f2937; font-weight:600; text-decoration:none;">Leer más →</a>
        </article>
      </div>
    ...
    <!-- ===== CARRUSEL AUTOMÁTICO ===== -->
    <?php
    // Carga automática de imágenes para el carrusel desde la carpeta 'carousel' dentro del proyecto.
    $carouselDir = __DIR__ . '/carousel';
    $carouselUrl = 'carousel'; // ruta relativa para usar en el src
    $imagenesCarrusel = [];
    if (is_dir($carouselDir)) {
        foreach (glob($carouselDir . '/*.{jpg,jpeg,png,gif,webp}', GLOB_BRACE) as $imgPath) {
            $imagenesCarrusel[] = $carouselUrl . '/' . basename($imgPath);
        }
    }
    ?>
    <section id="carrusel">
      <h2><i class="fas fa-images"></i> Carrusel</h2>
      <?php if (!empty($imagenesCarrusel)): ?>
        <div class="carrusel-wrapper" style="display:flex;gap:1rem;overflow:auto;padding:0.5rem 0;">
          <?php foreach ($imagenesCarrusel as $img): ?>
            <div style="flex:0 0 auto;">
              <img src="<?php echo htmlspecialchars($img); ?>" alt="Carrusel" style="height:140px;border-radius:8px;object-fit:cover;border:2px solid #e5e7eb;">
            </div>
          <?php endforeach; ?>
        </div>
      <?php else: ?>
        <p style="color:#6b7280;">No hay imágenes en el carrusel. Coloca archivos jpg, png, gif o webp en la carpeta /carousel</p>
      <?php endif; ?>
    </section>
