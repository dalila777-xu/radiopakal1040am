      ...
      <div class="carousel">
        <div class="carousel-track">
          <div class="carousel-item">
            <img src="B.png" alt="Equipo de Radio Pakal en cabina" onerror="this.src='https://placehold.co/800x450?text=Radio+Pakal+1'">
          </div>
          <div class="carousel-item">
            <img src="D.png" alt="Transmisión en vivo" onerror="this.src='https://placehold.co/800x450?text=Radio+Pakal+2'">
          </div>
          <div class="carousel-item">
            <img src="A.png" alt="Comunidades conectadas" onerror="this.src='https://placehold.co/800x450?text=Radio+Pakal+3'">
          </div>
          <div class="carousel-item">
            <img src="g.png" alt="Actividad comunitaria" onerror="this.src='https://placehold.co/800x450?text=Radio+Pakal+4'">
          </div>
          <div class="carousel-item">
            <img src="l.png" alt="Radio y cultura" onerror="this.src='https://placehold.co/800x450?text=Radio+Pakal+5'">
          </div>
        </div>
        <button class="carousel-control prev" type="button" aria-label="Anterior">&#10094;</button>
        <button class="carousel-control next" type="button" aria-label="Siguiente">&#10095;</button>
        <div class="carousel-dots">
          <button class="carousel-dot active" type="button" data-index="0" aria-label="Slide 1"></button>
          <button class="carousel-dot" type="button" data-index="1" aria-label="Slide 2"></button>
          <button class="carousel-dot" type="button" data-index="2" aria-label="Slide 3"></button>
          <button class="carousel-dot" type="button" data-index="3" aria-label="Slide 4"></button>
          <button class="carousel-dot" type="button" data-index="4" aria-label="Slide 5"></button>
        </div>
      </div>
    </section>
