...
<body>
  ...
  <div class="container">
    ...
    <section id="quienes">
      ...
      <!-- Carousel de 5 fotos que rota cada 2 segundos -->
      <div class="carousel" id="aboutCarousel" style="max-width:520px; margin:auto; overflow:hidden; border-radius:8px;">
        <div class="carousel-track" style="display:flex; transition:transform 1.6s ease;">
          <img src="img1.jpg" alt="Foto 1" style="width:100%; flex-shrink:0;" onerror="this.src='https://placehold.co/520x300?text=Foto+1'">
          <img src="img2.jpg" alt="Foto 2" style="width:100%; flex-shrink:0;" onerror="this.src='https://placehold.co/520x300?text=Foto+2'">
          <img src="img3.jpg" alt="Foto 3" style="width:100%; flex-shrink:0;" onerror="this.src='https://placehold.co/520x300?text=Foto+3'">
          <img src="img4.jpg" alt="Foto 4" style="width:100%; flex-shrink:0;" onerror="this.src='https://placehold.co/520x300?text=Foto+4'">
          <img src="img5.jpg" alt="Foto 5" style="width:100%; flex-shrink:0;" onerror="this.src='https://placehold.co/520x300?text=Foto+5'">
        </div>
      </div>
      <script>
        (function(){
          ...
          // make images responsive by setting track width
          track.style.width = (total * 100) + '%';
          for(var i=0;i<total;i++) slides[i].style.width = (100/total) + '%';
        })();
      </script>
    </section>
