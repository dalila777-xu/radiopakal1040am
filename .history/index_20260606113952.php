...
<body>
  ...
  <nav>
    ...
    <a href="#facebook-feed"><i class="fab fa-facebook"></i> Facebook</a>
    ...
    <section id="facebook-feed">
      ...
      <div class="facebook-feed-container">
        <div class="fb-page" 
          ...
          <blockquote cite="https://www.facebook.com/search/top?q=XEPLE%20Radio%20Palenque" class="fb-xfbml-parse-ignore">
            <a href="https://www.facebook.com/search/top?q=XEPLE%20Radio%20Palenque">XEPLE Radio Palenque</a>
          </blockquote>
        </div>
      </div>
    </section>

    <!-- MÓDULO 3.1: Redes Sociales -->
    <section id="redes">
  ...
  <!-- Facebook SDK -->
  <script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v18.0" nonce="8pv1W7eK"></script>
