<?php
// ==========================================
// CONFIGURACIÓN DE SUPABASE (integrada aquí)
// ==========================================
define('SUPABASE_URL', 'https://cwfydsatojsahuojvt.supabase.co');
define('SUPABASE_KEY', 'sb_publishable_y-xMjQxSFvPaMusgSkT8Gg_9iFBM...'); // ¡CAMBIA ESTO POR TU CLAVE COMPLETA!
    ...
    <section id="redes">
      ...
      <div class="grid-buttons">
        <a href="https://www.facebook.com/RadioPakalCapitalMaya" target="_blank" class="btn-card facebook-btn">
          <i class="fab fa-facebook-f"></i> Facebook: XEPLE Radio Pakal, Capital Maya
        </a>
