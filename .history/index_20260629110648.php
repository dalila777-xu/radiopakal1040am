...
// Obtener noticias
$query_noticias = "SELECT id, titulo, contenido, autor, fecha_creacion, imagen FROM publicaciones WHERE activo = 1 ORDER BY id DESC LIMIT 6";
$result_noticias = mysqli_query($conn, $query_noticias);
$noticias = [];
if ($result_noticias && mysqli_num_rows($result_noticias) > 0) {
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    nav a i { font-size: 0.85rem; color: #0d47a1; }
    nav a:hover { background: #eef2ff; color: #0d47a1; }
    nav a:hover i { color: #D4AF37; }
    ...
    nav a.destacado i { color: white; }
    nav a.destacado:hover { background: #0a3a7a; }
    ...
    section h2 i { color: #0d47a1; font-size: 1.5rem; }
    ...
    .mv-block h3 { margin-bottom: 0.8rem; color: #0d47a1; }
    ...
    .carousel-btn:hover { background: #0d47a1; transform: translateY(-50%) scale(1.05); }
    ...
    .carousel-dot.active { background: #0d47a1; transform: scale(1.2); }
    ...
    .tarjeta-noticia .btn-leer:hover {
      color: #D4AF37;
    }
    ...
    .app-btn { background: linear-gradient(135deg, #0d47a1 0%, #1565c0 100%); color: white; }
    ...
    @media (max-width: 768px) {
      ...
      .menu-hamburguesa { font-size: 1.5rem; }
    }
...
<body>
  ...
  <div class="nav-container">
    <button class="menu-hamburguesa" id="menuToggle" aria-label="Menú de navegación">
    ...
    <nav id="navMenu">
      ...
      <?php if (isset($_SESSION['usuario'])): ?>
        <a href="admin.php" class="destacado"><i class="fas fa-user-cog"></i> Panel</a>
      <?php else: ?>
        <a href="?page=login" class="destacado"><i class="fas fa-sign-in-alt"></i> Iniciar Sesión</a>
      <?php endif; ?>
    </nav>
  </div>
  ...
  <div class="container">
            ...
            <div class="carousel-track-container">
              <ul class="carousel-track">
                <?php if (!empty($carrusel_imagenes)): ?>
                  ...
                  <?php endforeach; ?>
                <?php else: ?>
                  <li class="carousel-slide"><img src="B.png" alt="Radio Pakal 1" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                  <li class="carousel-slide"><img src="D.png" alt="Radio Pakal 2" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                  <li class="carousel-slide"><img src="g.png" alt="Radio Pakal 3" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                  <li class="carousel-slide"><img src="l.png" alt="Radio Pakal 4" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                <?php endif; ?>
              </ul>
            </div>
    ...
    <section id="noticias">
      <h2><i class="fas fa-newspaper"></i> Noticias y Publicaciones</h2>
      <div style="display:flex; flex-wrap:wrap; gap:1rem; margin-top:0.75rem;">
        <?php if (!empty($noticias)): ?>
          <?php foreach ($noticias as $noticia): 
            $resumen = substr(strip_tags($noticia['contenido']), 0, 150) . '...';
            $fecha = date('d/m/Y', strtotime($noticia['fecha_creacion']));
            $imagen = !empty($noticia['imagen']) ? $noticia['imagen'] : '';
          ?>
            <article class="tarjeta-noticia">
              ...
              <small><i class="far fa-calendar-alt"></i> <?php echo $fecha; ?> | <i class="far fa-user"></i> <?php echo htmlspecialchars($noticia['autor']); ?></small>
              <p><?php echo htmlspecialchars($resumen); ?></p>
              <a href="noticia.php?id=<?php echo $noticia['id']; ?>" class="btn-leer">Leer más <i class="fas fa-arrow-right" style="font-size:0.7rem;"></i></a>
            </article>
          <?php endforeach; ?>
        <?php else: ?>
          <p style="color:#6b7280; font-style:italic; padding:1rem;">📢 No hay publicaciones disponibles en este momento.</p>
        <?php endif; ?>
      </div>
    </section>
      ...
      <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 2rem; margin-top: 0.5rem;">
          <div style="text-align: center; flex-shrink: 0;">
              <img src="pp.png" 
                   ...
                   style="width: 200px; height: 200px; border-radius: 12px; border: 3px solid #D4AF37; padding: 8px; background: white;"
          ...
          <div style="flex: 1; min-width: 200px;">
              ...
              <p style="font-size: 0.85rem; color: #4b5563; margin: 0.3rem 0 0.8rem;">
                  Escanea el código QR para descargar la app en tu dispositivo.
              </p>
          </div>
      </div>
    </section>
    ...
    <section id="ubicacion">
      ...
      <h2 style="font-size:1.2rem; margin-top:1.5rem;"><i class="fas fa-phone-alt"></i> Nuestros Teléfonos</h2>
      <p><strong>Oficina:</strong> (916) 688 0170</p>
      <p><strong>Cabina:</strong> (916) 345 3692</p>
      <iframe 
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        menuToggle.addEventListener('click', function() {
            ...
            if (menuVisible) {
                navMenu.classList.remove('nav-oculto');
                menuToggle.innerHTML = '<i class="fas fa-bars"></i>';
            } else {
                navMenu.classList.add('nav-oculto');
    ...
    window.addEventListener('scroll', () => {
        ...
        navLinks.forEach(link => {
            ...
            if (link.getAttribute('href') === `#${current}`) {
                ...
                link.style.background = '';
                link.style.color = '';
                if (icon) icon.style.color = '#0d47a1';
            }
        });
    });
  </script>
