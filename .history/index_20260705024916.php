            ...
            <div class="carousel-track-container">
              <ul class="carousel-track">
                ...
                <?php else: ?>
                  ...
                  <li class="carousel-slide"><img src="7.png" alt="Radio Pakal 1" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                  <li class="carousel-slide"><img src="B.png" alt="Radio Pakal 2" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                  <li class="carousel-slide"><img src="zzz7.png" alt="Radio Pakal 3" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                  <li class="carousel-slide"><img src="g.png" alt="Radio Pakal 4" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                  <li class="carousel-slide"><img src="D.png" alt="Radio Pakal 5" onerror="this.src='https://placehold.co/900x400?text=Radio+Pakal'"></li>
                <?php endif; ?>
              </ul>
            </div>
