...
if (isset($_GET['page']) && $_GET['page'] === 'login') {
  ...
  <head>
    ...
    *{margin:0;padding:0;box-sizing:border-box;font-family:'Inter',sans-serif}
    ...
    .btn-submit{background:#1a56db;color:white;border:none;width:100%;padding:.75rem;border-radius:6px;font-size:1rem;font-weight:600;cursor:pointer;margin-top:.5rem}
    ...
    .back-link{display:block;text-align:center;margin-top:1.2rem;color:#1a56db;text-decoration:none;font-size:.85rem;font-weight:500}
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    header h1 { color: #1a56db; font-size: 1.8rem; margin-bottom: 0.5rem; }
    header p { color: #000000; font-size: 1rem; }

    /* ========================================
       NAVEGACIÓN - COLORES AZUL Y DORADO
    ======================================== */
    nav {
      background: white;
      display: flex;
    ...
    nav a i { font-size: 0.9rem; color: #1a56db; }
    nav a:hover { background: #1a56db; color: white; }
    ...
    .carousel-btn:hover { background: #1a56db; transform: translateY(-50%) scale(1.05); }
    ...
    .carousel-dot.active { background: #1a56db; transform: scale(1.2); }
    ...
    .btn-facebook { background: #1a56db; color: white; }
    .btn-facebook:hover { background: #0d3a9e; }

    .btn-whatsapp { background: #25D366; color: white; }
    .btn-whatsapp:hover { background: #1a9e4a; }

    .btn-app { background: linear-gradient(135deg, #1a56db 0%, #D4AF37 100%); color: white; }
    .btn-app:hover { opacity: 0.9; }

    .btn-download { background: #D4AF37; color: #1a1a2e; }
    .btn-download:hover { background: #b8941f; }
...
<body>
  ...
  <div class="container">
    ...
    <!-- ===== REDES SOCIALES ===== -->
    <section id="redes">
      <h2><i class="fab fa-facebook" style="color:#1a56db;"></i> Síguenos en Redes Sociales</h2>
      <div class="grid-buttons">
        <a href="https://www.facebook.com/RadioPakalCapitalMaya" target="_blank" class="btn-card btn-facebook">
          <i class="fab fa-facebook-f"></i> Facebook: XEPLE Radio Palenque
        </a>
        <a href="https://wa.me/529935990830" target="_blank" class="btn-card btn-whatsapp">
    ...
    ========================================== -->
    <section id="app">
      <h2><i class="fas fa-download" style="color:#D4AF37;"></i> Lleva la Radio en tu Bolsillo</h2>
      ...
      <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 2rem; margin-top: 0.5rem;">
          ...
          <div style="flex: 1; min-width: 200px;">
              ...
              <p style="font-size: 0.85rem; color: #4b5563; margin: 0.3rem 0 0.8rem;">
                  Escanea el código QR o descarga directamente desde las tiendas oficiales.
              </p>
              
              <div style="display: flex; flex-wrap: wrap; gap: 0.8rem;">
                  <!-- Google Play -->
                  <a href="https://play.google.com/store/apps/details?id=com.radiopakal.app" 
                     target="_blank" 
                     class="btn-card btn-app">
                      <i class="fab fa-google-play"></i> Google Play
                  </a>
                  
                  <!-- App Store -->
                  <a href="https://apps.apple.com/app/radio-pakal/id123456789" 
                     target="_blank" 
                     class="btn-card btn-app">
                  ...
                  <a href="https://radio-pakal.net/app.apk" 
                     target="_blank" 
    ...
    <section id="ubicacion">
      <h2><i class="fas fa-location-dot" style="color:#D4AF37;"></i> Nuestra Ubicación</h2>
    ...
    window.addEventListener('scroll', () => {
        ...
        navLinks.forEach(link => {
            ...
            if (link.getAttribute('href') === `#${current}`) {
                link.style.background = '#1a56db';
                link.style.color = 'white';
                if (icon) icon.style.color = 'white';
            } else {
                if (icon) icon.style.color = '#1a56db';
            }
        });
    });
  </script>
