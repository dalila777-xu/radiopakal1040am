...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* --- RESPONSIVO --- */
    /* Imagen de sección convertida a fondo para mostrar guitarra de fondo */
    .about-img {
      display: block;
      width: 100%;
      height: 320px; /* ajustar altura según prefieras */
  ...
  <div class="container">
    ...
    <section id="redes">
      ...
      <div class="grid-buttons">
        <a href="https://https://www.facebook.com/XEPLERadioPalenque.gob.mx/radio" target="_blank" class="btn-card facebook-btn">
          📘 Facebook Oficial
        </a>
