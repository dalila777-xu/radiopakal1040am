  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media (max-width: 480px) {
      ...
      .carousel-dots { padding: 0.3rem; gap: 5px; }
            ...
            <div class="carousel-track-container" style="width:100%; height:100%; overflow:hidden;">
              <ul class="carousel-track">
                <?php if (!empty($carrusel_imagenes)): ?>
                  ...
                  <?php endforeach; ?>
                <?php else: ?>
                  <li class="carousel-slide"><img src="7.png" alt="Radio Pakal 1"></li>
                  <li class="carousel-slide"><img src="B.png" alt="Radio Pakal 2"></li>
                  <li class="carousel-slide"><img src="zzz7.png" alt="Radio Pakal 3"></li>
                  <li class="carousel-slide"><img src="g.png" alt="Radio Pakal 4"></li>
                  <li class="carousel-slide"><img src="D.png" alt="Radio Pakal 5"></li>
                <?php endif; ?>
              </ul>
            </div>
          ...
          <?php foreach ($publicacionesRecientes as $publicacion): ?>
            ...
            <article class="tarjeta-noticia">
              <?php if (!empty($imagenPublicacion)): ?>
                <img src="<?php echo htmlspecialchars($imagenPublicacion); ?>" alt="<?php echo htmlspecialchars($publicacion['titulo'] ?? 'Noticia'); ?>" onerror="this.onerror=null;this.src='https://placehold.co/600x400?text=Sin+imagen'">
              <?php else: ?>
                <div style="width:100%; height:160px; display:flex; align-items:center; justify-content:center; border-radius:6px; background:#f3f4f6; color:#6b7280; font-size:0.95rem;">Sin imagen</div>
              <?php endif; ?>
              <div>
                <h3><?php echo htmlspecialchars($publicacion['titulo'] ?? 'Noticia sin título'); ?></h3>
                <p><?php echo htmlspecialchars($publicacion['resumen'] ?? substr(strip_tags($publicacion['contenido'] ?? ''), 0, 150) . '...'); ?></p>
              </div>
            </article>
          <?php endforeach; ?>
        <?php else: ?>
          <article class="tarjeta-noticia">
            ...
            <p>Por el momento no se encontraron publicaciones recientes.</p>
          </article>
        <?php endif; ?>
      </div>
    </section>
