    ...
    <section id="quienes">
      ...
      <div class="carousel">
        <div class="carousel-track">
          ...
          <div class="carousel-item">
            <img src="C.png" alt="Actividad comunitaria" onerror="this.src='https://placehold.co/800x450?text=Radio+Pakal+4'">
          </div>
          <div class="carousel-item">
            <img src="E.png" alt="Radio y cultura" onerror="this.src='https://placehold.co/800x450?text=Radio+Pakal+5'">
          </div>
        </div>
