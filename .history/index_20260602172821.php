...
<body>
  ...
  <header>
    ...
    <h1 class="fade-in">Radio Pakal 1040 AM</h1>
    <p class="fade-in-delay">La voz de Palenque que conecta con la comunidad</p>
  </header>
  ...
  <div class="container">
    ...
    <section id="ubicacion">
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!..." width="100%" height="350" style="border:0;" allowfullscreen></iframe>
    </section>
  </div>
