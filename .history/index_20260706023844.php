...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* ========================================
       CARRUSEL OPTIMIZADO - BORDE DORADO Y TÍTULOS GRANDES
    ======================================== */
    .carousel-container {
      position: relative;
      width: 100%;
    ...
    @media (max-width: 1024px) {
        ...
        .carousel-slide .slide-title { font-size: 1.4rem; left: 24px; bottom: 24px; }
        .carousel-slide .slide-title span { font-size: 0.85rem; }
    }
...
<body>
  ...
  <div class="container">
    ...
    <section id="quienes">
      ...
      <!-- ========================================
      CARRUSEL CON BORDE DORADO Y TÍTULOS GRANDES
      ======================================== -->
