...
<body>
  ...
  <header>
    <img src="imagen.png" alt="📻" class="imagen.png">
  ...
  <div class="container">
    ...
    <section id="quienes">
      ...
      <img src="poner imagen " alt="Imagen de Radio Pakal 1040" class="about-img">
    </section>
    ...
    <section id="ubicacion">
      ...
      <p style="color:#555; font-size:0.9rem;">Nota: Mapas de Bing no encontró "Av. Corregidora S/N entre Calle Chiapas y Calle Francisco Javier Mina. A unos pasos del Colegio Palenque, Palenque, Mexico, 29960".</p>
