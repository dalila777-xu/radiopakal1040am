...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .form-group input:focus { border-color: #0099FF; background: #fff; }
        ...
        /* ========================================
           GRID DE IMÁGENES - MISMO ESTILO QUE PUBLICACIONES
        ======================================== */
        .grid-imagenes { 
            display: grid; 
...
<body>
    ...
    <div class="form-container">
        <h3><?php echo "📸 Subir Nueva Imagen"; ?></h3>
    ...
    <h3 class="section-title"><i class="fas fa-history"></i> Imágenes Activas</h3>
